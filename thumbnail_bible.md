# HUMANOS Thumbnail Bible & Design System v1.0
**Status:** ACTIVE  
**Owner:** Jota Ochoa  
...
## 1. Filosofía de Miniaturas (Thumbnail Philosophy)
...
## 5. Variaciones de Formato y Plataformas

### A. Formato Vertical (9:16) - Instagram Reels / YouTube Shorts / TikTok
* **Posicionamiento:** El rostro del personaje va centrado ocupando la parte superior y media.
* **Área de Texto:** Los textos se colocan alineados en la esquina inferior izquierda.
* **Margen de Seguridad:** Mantener los textos dentro de la zona del **75% al 80% de la altura de la pantalla** para evitar que sean bloqueados por la interfaz nativa de la aplicación (nombre de cuenta, likes, comentarios).

### B. Formato Horizontal (16:9) - YouTube Clásico / Facebook Video
* **Posicionamiento:** El retrato del personaje se desplaza hacia un lateral (usualmente el derecho).
* **Área de Texto:** El bloque de texto se maquetará en el lateral opuesto con alineación a la izquierda.
* **Espacio Negativo:** Se debe dejar una zona amplia de negro absoluto o degradado oscuro como espacio de respiración visual.
