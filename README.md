...
|---|---|---|
| 1 | Publicar los primeros 3 pilotos | 🟡 En curso |
...
1. **Jan Koum** — El inmigrante que creó WhatsApp
2. **Ehud Shabtai** — Odiaba perderse conduciendo. Creó Waze.
3. **Cliff Kushler** — Todos usamos su invento. Casi nadie sabe su nombre.
